    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "20px" }}>
          <h2 style={{ margin: 0, fontSize: "22px", fontWeight: 800, color: "#1E3A8A" }}>
        ...
        >
          {/* Info Grid */}
          <div>
            <h3 style={{ margin: "0 0 10px 0", fontSize: "20px", fontWeight: 800, color: "#1E3A8A", textTransform: "capitalize" }}>
              {product.name}
            </h3>
          ...
          <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "13px" }}>
            <thead>
              <tr style={{ background: "#F0F5FF", borderBottom: "1px solid #E2E8F0" }}>
                <th style={{ padding: "12px 16px", textAlign: "left", color: "#1E3A8A", fontWeight: 700, fontSize: "11px", letterSpacing: "0.5px" }}>DATE ADDED</th>
                <th style={{ padding: "12px 16px", textAlign: "left", color: "#1E3A8A", fontWeight: 700, fontSize: "11px", letterSpacing: "0.5px" }}>QUANTITY</th>
                <th style={{ padding: "12px 16px", textAlign: "left", color: "#1E3A8A", fontWeight: 700, fontSize: "11px", letterSpacing: "0.5px" }}>UNIT COST</th>
                <th style={{ padding: "12px 16px", textAlign: "left", color: "#1E3A8A", fontWeight: 700, fontSize: "11px", letterSpacing: "0.5px" }}>SUPPLIER</th>
                <th style={{ padding: "12px 16px", textAlign: "left", color: "#1E3A8A", fontWeight: 700, fontSize: "11px", letterSpacing: "0.5px" }}>STATUS</th>
                {isAdmin && (
                  <th style={{ padding: "12px 16px", textAlign: "right", color: "#1E3A8A", fontWeight: 700, fontSize: "11px", letterSpacing: "0.5px" }}>ACTIONS</th>
                )}
              </tr>
            </thead>
            <tbody>
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: "14px" }}>
            ...
            <div>
              <div style={{ fontSize: "13px", fontWeight: 800, color: "#1D4ED8", letterSpacing: "0.3px" }}>
                PRICE INCREASED
              </div>
